...
const SingleData = ({ attack, defense, hp, name, speed, image, total }) => {
    ...
    return (
        <div className='relative'>
            <div className="h-fit relative w-[5rem]">
                ...
                <div className=""> <LazyLoadImage effect="blur" src={image} alt="" style={{ width: '7rem' }} className="w-full" /> </div>
                <div className="bg-white rounded-md text-xs font-semibold txt-slate-600 shadow-xl text-center px-2 py-1.5">{name}</div>
            </div>
